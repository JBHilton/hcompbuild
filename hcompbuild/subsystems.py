...
from numpy import (
        arange, array, atleast_2d, concatenate, cumprod, diag, ix_,
        ones, sum, where, zeros)
from numpy import int64 as my_int
import pdb # We bring this in because it's relatively easy to make mistakes setting up SEPIRQ model
